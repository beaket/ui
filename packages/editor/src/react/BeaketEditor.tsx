...
import type { EditorOptions } from "../editor/createEditor";
import { createEditor } from "../editor/createEditor";
import type { HighlightController, HighlightInput } from "../editor/extensions/highlightLayer";
import { createHighlightController } from "../editor/extensions/highlightLayer";
import type { ValueController } from "../editor/valueController";
import { createValueController } from "../editor/valueController";
...
export interface BeaketEditorHandle {
  getValue(): string;
...
export interface BeaketEditorProps {
...
export const BeaketEditor = forwardRef<BeaketEditorHandle, BeaketEditorProps>(function BeaketEditor(
  {
    defaultValue,
    onChange,
    highlights,
  ...
  useImperativeHandle(
    ...
    (): BeaketEditorHandle => ({
      ...
      getView: () => {
        const view = viewRef.current;
        if (!view) throw new Error("BeaketEditor: view is not mounted yet");
        return view;
      },
    }),
    [],
