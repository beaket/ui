...
- [#1011](https://github.com/beaket/ui/pull/1011) [`a3b7a81`](https://github.com/beaket/ui/commit/a3b7a81b4490c4860f8f7a5c5cae22dd46094132) Thanks [@jihnma](https://github.com/jihnma)! - Route the table's column/row structure menu through the shared `PopupMenu` engine.
  ...
  "close once the anchor leaves the scroller" rule ([#541](https://github.com/beaket/ui/issues/541)), its own outside-click
  close ([#471](https://github.com/beaket/ui/issues/471)). `menu-engine.ts` exists so those parts are written once, and ADR-0016
  ...
  ([#483](https://github.com/beaket/ui/issues/483)). The table reports the subview; every other menu reports the main view.
