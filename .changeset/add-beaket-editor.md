...
Add `@beaket/editor`: a markdown-first, CJK-first Live Preview editor, published as a standalone npm package (not a copy-paste registry component).

- Framework-agnostic core (`@beaket/editor`, `createEditor`) with zero React, plus a thin React wrapper (`@beaket/editor/react`, `<BeaketEditor>`).
