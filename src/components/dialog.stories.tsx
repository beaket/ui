...
import AllDialogStatesExample from "../examples/dialog/all-states";
import DefaultDialogExample from "../examples/dialog/default";
...
export const AllStates = () => <AllDialogStatesExample />;
...
export const InteractionTest: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // Keyboard opens the dialog, keeps focus trapped inside it, and restores the trigger.
    ...
    // Default dialog: closes via its X button
