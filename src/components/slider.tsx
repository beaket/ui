...
export function SliderTrack({ className, ...props }: SliderTrackProps) {
  return (
    <SliderPrimitive.Track
      ...
      className={cn(
        "border-border-strong bg-bg-input data-[disabled]:border-border-muted data-[disabled]:bg-bg-disabled relative grow overflow-hidden border data-[disabled]:border-dashed data-[orientation=horizontal]:h-2 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-2",
        className,
      )}
      {...props}
    />
...
export function SliderThumb({ className, ...props }: SliderThumbProps) {
  return (
    <SliderPrimitive.Thumb
      ...
      className={cn(
        "border-border-strong bg-bg-input relative block size-5 border before:absolute before:inset-[-12px] before:content-['']",
        "hover:shadow-offset-action focus-visible:outline-border-focus cursor-grab focus-visible:outline-2 focus-visible:outline-offset-2 active:translate-y-px active:cursor-grabbing",
        "data-[disabled]:border-border-muted data-[disabled]:bg-bg-disabled data-[disabled]:cursor-not-allowed data-[disabled]:border-dashed data-[disabled]:shadow-none",
        className,
      )}
      {...props}
    />
