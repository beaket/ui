...
const colors = {
  ...
  neutral: [
    { name: "Graphite", variable: "--color-graphite", hex: "#1e2229", usage: "Prose body text" },
    { name: "Ink", variable: "--color-ink", hex: "#0a0d14", usage: "UI primary, strong border" },
    { name: "Iron", variable: "--color-iron", hex: "#15191f", usage: "Dark accent" },
