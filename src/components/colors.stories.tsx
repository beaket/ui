 ...
 * - The 64 semantic names below are authored once and shared by every theme —
      ...
      <div className="max-w-4xl">
        ...
        <div className="border-border mb-8 border-b pb-4">
          ...
          <p className="text-fg-muted mt-1 text-sm">
            Two layers. A theme authors 32 palette values and nothing else; the 64 semantic names
...
const meta: Meta<typeof Colors> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Two-layer brutalist color system: 32 theme-authored palette values, 64 shared semantic names. Components only use the semantic layer. No gradients, no blur shadows, no opacity effects.",
      },
    },
  },
};
