...
// This is deliberately an explicit client registry. Keep static examples in
// StoryPreview's server-only boundary, and never import Storybook stories here.
...
export function hasInteractiveExample(componentName: string, storyName = "Default") {
  return `${componentName}/${storyName}` in interactiveExamples;
}
